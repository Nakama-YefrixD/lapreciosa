                ...
                <div className="form-group">
                    <div className="row">
                        ...
                        <div className="col-3">
                            ...
                            <input type="text" className="form-control" value ="Soles" name="dateFactura" id="dateFactura"/>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="descuento">
                                        ...
                                        <input type="hidden" className="form-control cantidaddp" name="cantidaddp[]" value="0" readonly=""/>
                                        <input type="hidden" className="form-control porcentajedp" name="porcentajedp[]" value="0" readonly=""/>
                                    </td>
                                    <td className="subtotal">
                                        <span>0</span>
                                        <input type="hidden" className="form-control subtotal" name="subtotal[]" value="0" readonly="" style={{width: '100px'}}/>
                                    </td>
                                    <td className="total">
                                        <span>0</span>
                                        <input type="hidden" className="form-control total" name="total[]" value="0" readonly="" style={{width: '100px'}}/>
                                    </td>
                                    <td>
